...
**קורס:** טכנולוגיות אינטרנט — Become a Full-Stack Engineer, RUNI CS 2026
**מסמך:** 3 מתוך 11 (עיצוב טכני, שלב 4 של המטלה)
**תלוי ב:** `01-product-spec.md` (חוקים), `02-architecture.md` (מבנה)
**סטטוס:** טיוטה לסקירה
